The files in this folder define the terms used in DESM mappings, that is the mapping predicates we recommend using and the properties and classes used for machine readable output in JSON-LD / RDF.
